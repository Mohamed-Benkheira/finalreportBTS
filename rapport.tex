...
\begin{figure}[htbp]
  \centering
  \resizebox{0.9\textwidth}{!}{\input{diagrams/web-architecture.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{\input{diagrams/inertia-bridge.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{\input{diagrams/laravel-mvc.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.95\textwidth}{!}{\input{diagrams/rbac.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{\input{diagrams/org-chart.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.92\textwidth}{!}{\input{diagrams/existing-workflow.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{!}{0.4\textheight}{\input{diagrams/activity-org.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{!}{0.4\textheight}{\input{diagrams/activity-employee.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{!}{0.4\textheight}{\input{diagrams/activity-project.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{!}{0.4\textheight}{\input{diagrams/activity-assignment.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{!}{0.4\textheight}{\input{diagrams/activity-dashboard.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{!}{0.4\textheight}{\input{diagrams/activity-audit.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{!}{0.4\textheight}{\input{diagrams/activity-recommendation.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{!}{0.4\textheight}{\input{diagrams/activity-profile.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{diagrams/sequence-auth.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{diagrams/sequence-org.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{diagrams/sequence-employee.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{diagrams/sequence-project.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{diagrams/sequence-assignment.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{diagrams/sequence-dashboard.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{diagrams/sequence-audit.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{diagrams/sequence-portal.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{diagrams/sequence-recommendation.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{\input{diagrams/class.tex}}
...
Attributes & id, name, email, password, email\_verified\_at, two\_factor\_secret, two\_factor\_recovery\_codes, remember\_token, created\_at, updated\_at \\
\hline
Methods & assignRole(), hasRole(), can(), delete() \\
\hline
\end{classtable}

\begin{classtable}{Class: Employee}
Attributes & id, user\_id, matricule, first\_name, last\_name, email, phone, hire\_date, employment\_status, employment\_type, department\_id, position\_id, location\_id, team\_id, manager\_id, created\_at, updated\_at, deleted\_at \\
\hline
Methods & skills(), certifications(), languages(), availabilities(), workloads(), assignments(), fullName() \\
\hline
\end{classtable}

\begin{classtable}{Class: Department}
Attributes & id, business\_unit\_id, name, code, description, head\_id, created\_at, updated\_at, deleted\_at \\
\hline
Methods & businessUnit(), employees(), teams() \\
\hline
\end{classtable}

\begin{classtable}{Class: Project}
Attributes & id, name, code, description, project\_category\_id, assignment\_mode, priority, status, start\_date, target\_end\_date, actual\_end\_date, estimated\_effort\_hours, confidentiality\_level, requested\_by, project\_manager\_id, created\_at, updated\_at, deleted\_at \\
\hline
Methods & assignments(), requirements(), category(), evaluations() \\
\hline
\end{classtable}

\begin{classtable}{Class: Assignment}
Attributes & id, project\_id, assigned\_by, approved\_by, assignment\_type, status, assigned\_at, approved\_at, start\_date, end\_date, notes, created\_at, updated\_at \\
\hline
Methods & project(), members(), teams(), statusHistory() \\
\hline
\end{classtable}

\begin{classtable}{Class: Skill}
Attributes & id, skill\_category\_id, name, code, description, created\_at, updated\_at, deleted\_at \\
\hline
Methods & category(), employees(), projects() \\
\hline
\end{classtable}

\begin{classtable}{Class: Certification}
Attributes & id, name, code, issuer, validity\_months, created\_at, updated\_at, deleted\_at \\
\hline
Methods & employees() \\
\hline
\end{classtable}
...
Attributes & id, name, code, created\_at, updated\_at, deleted\_at \\
\hline
Methods & employees() \\
\hline
\end{classtable}
...
Attributes & id, user\_id, action, auditable\_type, auditable\_id, old\_values, new\_values, ip\_address, user\_agent, created\_at \\
\hline
Methods & user(), auditable() \\
\hline
\end{classtable}

\begin{classtable}{Class: AssignmentStatusHistory}
Attributes & id, assignment\_id, old\_status, new\_status, changed\_by, reason, created\_at \\
\hline
Methods & assignment(), changedByUser() \\
\hline
\end{classtable}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.9\textwidth}{!}{\input{diagrams/deployment.tex}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{\input{diagrams/app-structure.tex}}
